...
2. 先建立叙事：身份或封面开场；摘要、数据、状态形成导览；能力、项目、经历构成主体；链接、行动或短引言负责收束。
3. 图片封面优先 hero，但不要连续出现两个 hero/single。
4. 项目、长标准卡、长清单是主内容；数据、便签、短引言、链接通常是辅内容。
5. 把语义互补的内容放在同一组，避免孤立小卡、无意义留白和尾部失衡。
6. trio 只用于三张短卡；quartet 只用于四张极短卡。长内容不要强塞多栏。
7. 最后一组必须形成视觉收束，不能留下单张轻量小卡孤岛。
8. 不输出解释、Markdown、坐标、宽度或任何 groups 之外的字段。`
